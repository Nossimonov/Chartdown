...
**Status: section 01 (document model) is drafted; all else is planned.** This directory is the single source of truth for the Chartdown language; anything not written here is not part of the language, including the illustrative sketch in the project README.
