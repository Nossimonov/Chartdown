...
**Status: spec-aligned** — valid under spec v0.7 (sections 01–08). Fulfills [#28](https://github.com/Nossimonov/Chartdown/issues/28): the flagship battlemap showcase, and the playground's opening document.
